...
class SpectrumSDXLCalibratedOld:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
NODE_CLASS_MAPPINGS = {"SpectrumSDXLCalibratedOld": SpectrumSDXLCalibratedOld}
NODE_DISPLAY_NAME_MAPPINGS = {"SpectrumSDXLCalibratedOld": "Spectrum Adaptive Forecaster with Calibration (Old)"}